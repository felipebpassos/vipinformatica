    ...
    return (
        <header className="bg-white shadow sticky top-0 z-50">
            <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16 items-center">
                    ...
                    <div className="hidden md:flex items-center gap-0">
                        ...
                        <div className="flex gap-4 ml-8">
                            <Link
                                href="https://dashboard.felipepassos.dev/login.php"
                    ...
                    >
                        ...
                        >
                            ...
                            {/* Ícone de X */}
                            <path
                                className={`transition-transform duration-200 ${isMenuOpen ? 'opacity-100' : 'opacity-0'}`}
                                fill="currentColor"
                ...
                {/* Menu Mobile */}
                <div className={`md:hidden ${isMenuOpen ? 'block' : 'hidden'} pb-4 transition-all duration-300`}>
